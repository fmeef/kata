...
// These functions are ignored because they are not marked as `pub`: `as_bytes`, `as_read`, `as_read`, `empty`, `from_app`, `from_circle_or_tag`, `from_circle_or`, `from_circle`, `from_user`, `get_bin`, `get_bytes`, `get_children_parent`, `get_children`, `get_parent_cache`, `get_type_str`, `get_type_u8`, `get_userhandle`, `into_option`, `is_none`, `maybe_cert_from_fingerprint`, `member_type`, `option_mut`, `option`, `thin`
...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `cmp`, `cmp`, `cmp`, `cmp`, `cmp`, `cmp`, `cmp`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `hash`, `hash`, `hash`, `hash`, `partial_cmp`, `partial_cmp`, `partial_cmp`, `partial_cmp`, `partial_cmp`, `partial_cmp`, `partial_cmp`, `read`
