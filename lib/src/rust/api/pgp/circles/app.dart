...
// These functions are ignored because they are not marked as `pub`: `as_bytes`, `as_read`, `as_str`, `delete`, `generic_read`, `id_hex`, `into_option`, `is_none`, `new_empty`, `option_mut`, `option`, `resign`, `tag_reader`, `to_read`
