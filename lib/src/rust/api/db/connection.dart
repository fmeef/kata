...
// These functions are ignored because they are not marked as `pub`: `connection`, `fire_watchers`, `new`, `setup_watchers`
...
abstract class SqliteDb implements RustOpaqueInterface, CertDao, Dao, TestDao {
  ...
  Future<void> fireWatcher({required String table});
